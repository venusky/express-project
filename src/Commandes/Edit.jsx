    ...
    const handleChange = (e) => {
        ...
        setCommande(prev => {
            ...
            if (field === 'pickups') {
                ...
                updatedCommande.pickups[idx][key] = value;
            } else {
                updatedCommande[field][key] = value;
            }
                ...
                <div className="column">
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input className="required-field" name="deliveryFee" type="number" value={commande?.deliveryFee} onChange={handleChange} /></td>
                            </tr>
                            <tr>
                                <th className="required">Montant Article</th>
                                <td><input className="required-field" name="codAmount" type="number" value={commande?.codAmount} onChange={handleChange} /></td>
                            </tr>
                            <tr>
                                <th>Créé le</th>
                    ...
                    <table>
                        <tbody>
                            <tr>
                                <th>Nom</th>
                                <td><input type="text" name="user.name" value={commande?.user?.name} onChange={handleChange} /></td>
                            </tr>
                            <tr>
                                <th>Téléphone</th>
                                <td><input type="text" name="user.phoneNumber" value={commande?.user?.phoneNumber} onChange={handleChange} /></td>
                            </tr>
                            <tr>
                                <th>WhatsApp</th>
                                <td><input type="text" name="user.whatsapp" value={commande?.user?.whatsapp} onChange={handleChange} /></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                        ...
                        <div key={index}>
                            <div className="section-header">Lieu de Récupération {index + 1}/{commande.pickups.length}
                                <div className="pickup-header">
                                    {
                                        index + 1 > 1 && <button type="button" className="btn btn-danger btn-sm" onClick={() => handleRemovePickup(index)}>Supprimer</button>
                                    }
                                </div>
                            </div>
                            <table>
                                <tbody>
                                    <tr>
                                        <th className="required">Nom du contact</th>
                                        <td><input className="required-field" type="text" name={`pickups.${index}.contact.name`} value={pickup.contact?.name} onChange={handleChange} /></td>
                                    </tr>
                                    <tr>
                                        <th className="required">Téléphone</th>
                                        <td><input className="required-field" type="text" name={`pickups.${index}.contact.phoneNumber`} value={pickup.contact?.phoneNumber} onChange={handleChange} /></td>
                                    </tr>
                                    <tr>
                                        <th className="required">Adresse</th>
                                        <td><input className="required-field" type="text" name={`pickups.${index}.address.name`} value={pickup.address?.name} onChange={handleChange} /></td>
                                    </tr>
                                    <tr>
                                        <th>Repère</th>
                                        <td><input type="text" name={`pickups.${index}.address.landmark`} value={pickup.address?.landmark} onChange={handleChange} /></td>
                                    </tr>
                                    <tr>
                                        <th className="required">Ville</th>
                                        <td><input className="required-field" type="text" name={`pickups.${index}.address.city`} value={pickup.address?.city} onChange={handleChange} /></td>
                                    </tr>
                                    <tr>
                                        <th className="required">Taille</th>
                                        <td>
                                            <select className="required-field" name={`pickups.${index}.size`} value={pickup.size} onChange={handleChange}>
                                    ...
                                    <tr>
                                        <th>Poids</th>
                                        <td><input type="number" name={`pickups.${index}.weight`} value={pickup.weight} onChange={handleChange} /></td>
                                    </tr>
                                    <tr>
                                        <th>Quantité</th>
                                        <td><input type="number" name={`pickups.${index}.quantity`} value={pickup.quantity} onChange={handleChange} /></td>
                                    </tr>
                                    <tr>
                                        <th>Dimensions</th>
                                        <td><input type="text" name={`pickups.${index}.dimensions`} value={pickup.dimensions} onChange={handleChange} /></td>
                                    </tr>
                                    <tr>
                                        <th>Description</th>
                                        <td><input type="text" name={`pickups.${index}.description`} value={pickup.description} onChange={handleChange} /></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ))}
                    <button type="button" className='btn btn-sm btn-primary' onClick={handleAddPickup}>Ajouter un lieu de récupération</button>
                </div>
                    ...
                    <table>
                        <tbody>
                            <tr>
                                ...
                                <td><input type="text" name="delivery.contact.name" value={commande.delivery.contact.name} onChange={handleChange} /></td>
                            </tr>
                            <tr>
                                <th className="required">Téléphone</th>
                                <td><input className="required-field" type="text" name="delivery.contact.phoneNumber" value={commande.delivery.contact.phoneNumber} onChange={handleChange} /></td>
                            </tr>
                            <tr>
                                <th className="required">Adresse</th>
                                <td><input className="required-field" type="text" name="delivery.address.name" value={commande.delivery.address.name} onChange={handleChange} /></td>
                            </tr>
                            <tr>
                                <th>Repère</th>
                                <td><input type="text" name="delivery.address.landmark" value={commande.delivery.address.landmark} onChange={handleChange} /></td>
                            </tr>
                            <tr>
                                <th className="required">Ville</th>
                                <td>
                                    <select className="required-field" name="delivery.address.city" value={commande.delivery.address.city} onChange={handleChange}>
                            ...
                            <tr>
                                <th>Type</th>
                                <td><input type="text" name="delivery.type" value={commande.delivery.type} onChange={handleChange} /></td>
                            </tr>
                            <tr>
                                <th>Date Limite</th>
                                <td>
                            ...
                            <tr>
                                <th>Instructions</th>
                                <td><input type="text" name="delivery.instructions" value={commande.delivery.instructions} onChange={handleChange} /></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
